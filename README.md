...
• Key factors learning-examples\manual_buy.py is currently using:

  - Creator SOL balance (rug filter; must be ≥ 0.1/1.0 depending on the check)
  - Top holder concentration (must be < 90%)
  - Bonding curve virtual SOL reserve (must be ≥ 0.5)
  - Token score (creator SOL + vSOL – top holder %) must be ≥ 20
  - 15‑second stabilization delay before checks
  - Slippage set to 10% for buy
  - Buy amount fixed at 0.00001 SOL
  - Only listens to “create” transactions on the Pump program via blockSubscribe

  If you want me to tighten, loosen, or add new factors (creator history, price
  impact, on‑chain volume, etc.), tell me which to adjust.
Token usage: total=112,433 input=97,764 (+ 430,592 cached) output=14,669 (reasoning 6,016)
To continue this session, run codex resume 019bdc40-cfc5-7350-b850-c22a42133551

C:\Users\marti\Desktop\openai\pumpfun-bonkfun-bot-main>
C:\Users\marti\Desktop\openai\pumpfun-bonkfun-bot-main>codex resume 019bd609-d096-7f80-a7e8-caffe0f8cd7b

(pump-bot) PS C:\Users\marti\Desktop\openai\pumpfun-bonkfun-bot-main> uv run learning-examples\mint_and_buy_v2.py